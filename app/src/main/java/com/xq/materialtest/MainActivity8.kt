...
class MainActivity8 : BaseActivity() {
...
////                    Toast.LENGTH_SHORT.showToast(this,"消息已撤回111")
//                    "消息已撤回".showToast(this)
////                    "消息已撤回".showToast(this,Toast.LENGTH_LONG)
////                    R.string.app_name.showToast(this)
//                }
//                .show()
           view.showSnackbar("消息已发送","撤回"){
               "消息已撤回".showToast(this)
           }
        }
